    ...
    switch (path) {
      case `/edisu`:
        return{
          ...
          image: "path/to/your/case-study-image-webp.webp", // Replace with an actual image URL
      ...
      case `/pat-app`:
        return{
          ...
          image: "path/to/your/pat-app-image-webp.webp", // Replace with an actual image URL for the case study
      ...
      case `/pro-id`:
        return{
          ...
          image: "path/to/your/image-webp.webp", // Replace with actual image URL
      ...
      case `/turin-startup-campaign`:
        return{
          ...
          image: "path/to/your/image-webp.webp", // Replace with an actual image URL
      ...
      case `/usa-startups`:
        return{
          ...
          image: "path/to/your/startup-page-image-webp.webp", // Replace with an actual image URL
      ...
      case `/ar-solutions`:
        return{
          ...
          image: "path/to/your/3d-ar-image-webp.webp", // Replace with an actual image URL
      ...
      case `/services`:
        return{
          ...
          url: "https://www.astutesoftwares.com", // Replace with your actual website URL
          image: "path/to/your/image-webp.webp", // Replace with an actual image URL, like a banner image or logo
      ...
      case `/contact-us`:
        return {
          ...
          image: "path/to/contact-page-image-webp.webp", // Replace with an image URL specific to the contact page
      ...
      case `/request-contact`:
        return {
          ...
          image: "path/to/your/contact-image-webp.webp", // Replace with an actual image URL for the contact page
      ...
      case `/request-contact-it`:
        return {
          ...
          image: "path/to/contact-image-webp.webp", // Replace with an actual image URL
      ...
      case `/blogs`:
        return {
          ...
          image: "path/to/your/blogs-image-webp.webp", // Replace with an actual image URL for the blog page
      ...
      case `/careers`:
        return {
          ...
          image: "path/to/your/image-webp.webp", // Replace with an actual image URL for the career page
      ...
      case `/coupons`:
        return {
          ...
          image: "path/to/coupon-image-webp.webp", // Replace with an actual image URL for the coupon page
      ...
      case `/services/software-quality-assurance`:
        return {
          ...
          image: "path/to/qa-image-webp.webp", // Replace with an image related to QA services (e.g., a picture of a tester or QA tools)
      ...
      case `/services/digital-transformation-services`:
        return {
          ...
          image: "path/to/your/image-webp.webp", // Replace with the actual image URL
      ...
      case `/services/ui-and-ux-design`:
        return {
          ...
          image: "path/to/your/ux-ui-image-webp.webp", // Replace with an actual image URL related to UX/UI services
      ...
      case `/services/blockchain-solutions`:
        return {
          ...
          image: "path/to/blockchain-image-webp.webp", // Replace with an actual image URL
      ...
      case `/services/devops-services`:
        return {
          ...
          image: "path/to/your/devops-image-webp.webp", // Replace with an actual image URL for DevOps
      ...
      case `/metaverse`:
        return {
          ...
          image: "path/to/your/image-webp.webp", // Replace with the actual image URL for this page
      ...
      case `/3d-modelling`:
        return {
          ...
          image: "path/to/your/image-webp.webp", // Replace with your actual image URL (e.g., a hero image or relevant image for 3D modeling)
      ...
      case `/portfolio`:
        return {
          ...
          image: "path/to/portfolio-image-webp.webp", // Replace with an actual image URL for the portfolio page
      ...
      case `/technologies/angular`:
        return {
          ...
          image: "path/to/your/angular-image-webp.webp", // Replace with an actual image URL
      ...
      case `/technologies/laravel`:
        return {
          ...
          image: "path/to/laravel-development-image-webp.webp", // Replace with an actual image URL
      ...
      case `/technologies/react`:
        return {
          ...
          image: "path/to/react-development-image-webp.webp", // Replace with an actual image URL
      ...
      case `/technologies/nodejs`:
        return {
          ...
          image: "path/to/your/node-development-image-webp.webp", // Replace with an actual image URL
      ...
      case `/technologies/vue`:
        return {
          ...
          image: "path/to/your/vuejs-image-webp.webp", // Replace with an actual image URL for this page
      ...
      case `/falling-gems`:
        return {
          ...
          image: "path/to/your/game-image-webp.webp", // Replace with an actual image URL for the game
      ...
      case `/cookie-policy`:
        return {
          ...
          image: "path/to/your/cookie-policy-image-webp.webp", // Replace with an actual image URL
      ...
      case `/privacy-policy`:
        return {
          ...
          image: "path/to/privacy-policy-image-webp.webp", // Replace with an actual image URL
