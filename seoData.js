    ...
    switch (path) {
      ...
      case `/pat-app`:
        return{
          ...
          image: "https://pro-id.s3.eu-central-1.amazonaws.com/media/THUMBNAIL-FOR-VIEW.jpg", // Replace with an actual image URL for the case study
      ...
      case `/pro-id`:
        return{
          ...
          image: "https://pro-id.s3.eu-central-1.amazonaws.com/media/THUMBNAIL-FOR-VIEW.jpg", // Replace with actual image URL
      ...
      case `/services`:
        return{
          ...
          image: "https://pro-id.s3.eu-central-1.amazonaws.com/media/THUMBNAIL-FOR-VIEW.jpg", // Replace with an actual image URL, like a banner image or logo
      ...
      case `/contact-us`:
        return {
          ...
          image: "https://pro-id.s3.eu-central-1.amazonaws.com/media/THUMBNAIL-FOR-VIEW.jpg", // Replace with an image URL specific to the contact page
      ...
      case `/request-contact`:
        return {
          ...
          image: "https://pro-id.s3.eu-central-1.amazonaws.com/media/THUMBNAIL-FOR-VIEW.jpg", // Replace with an actual image URL for the contact page
      ...
      case `/blogs`:
        return {
          ...
          image: "https://pro-id.s3.eu-central-1.amazonaws.com/media/THUMBNAIL-FOR-VIEW.jpg", // Replace with an actual image URL for the blog page
      ...
      case `/careers`:
        return {
          ...
          image: "https://pro-id.s3.eu-central-1.amazonaws.com/media/THUMBNAIL-FOR-VIEW.jpg", // Replace with an actual image URL for the career page
      ...
      case `/coupons`:
        return {
          ...
          image: "https://pro-id.s3.eu-central-1.amazonaws.com/media/THUMBNAIL-FOR-VIEW.jpg", // Replace with an actual image URL for the coupon page
      ...
      case `/services/software-quality-assurance`:
        return {
          ...
          image: "https://pro-id.s3.eu-central-1.amazonaws.com/media/THUMBNAIL-FOR-VIEW.jpg", // Replace with an image related to QA services (e.g., a picture of a tester or QA tools)
      ...
      case `/services/digital-transformation-services`:
        return {
          ...
          image: "https://pro-id.s3.eu-central-1.amazonaws.com/media/THUMBNAIL-FOR-VIEW.jpg", // Replace with the actual image URL
      ...
      case `/services/ui-and-ux-design`:
        return {
          ...
          image: "https://pro-id.s3.eu-central-1.amazonaws.com/media/THUMBNAIL-FOR-VIEW.jpg", // Replace with an actual image URL related to UX/UI services
      ...
      case `/services/devops-services`:
        return {
          ...
          image: "https://pro-id.s3.eu-central-1.amazonaws.com/media/THUMBNAIL-FOR-VIEW.jpg", // Replace with an actual image URL for DevOps
      ...
      case `/metaverse`:
        return {
          ...
          image: "https://pro-id.s3.eu-central-1.amazonaws.com/media/THUMBNAIL-FOR-VIEW.jpg", // Replace with the actual image URL for this page
      ...
      case `/3d-modelling`:
        return {
          ...
          image: "https://pro-id.s3.eu-central-1.amazonaws.com/media/THUMBNAIL-FOR-VIEW.jpg", // Replace with your actual image URL (e.g., a hero image or relevant image for 3D modeling)
      ...
      case `/portfolio`:
        return {
          ...
          image: "https://pro-id.s3.eu-central-1.amazonaws.com/media/THUMBNAIL-FOR-VIEW.jpg", // Replace with an actual image URL for the portfolio page
      ...
      case `/technologies/vue`:
        return {
          ...
          image: "https://pro-id.s3.eu-central-1.amazonaws.com/media/THUMBNAIL-FOR-VIEW.jpg", // Replace with an actual image URL for this page
      ...
      case `/falling-gems`:
        return {
          ...
          image: "https://pro-id.s3.eu-central-1.amazonaws.com/media/THUMBNAIL-FOR-VIEW.jpg", // Replace with an actual image URL for the game
