...
const createCamera = () => {
  const camera = new THREE.PerspectiveCamera(3.6, document.getElementById("modelPlace").clientWidth / document.getElementById("modelPlace").clientHeight, 20, 4e3);
...
const createModel = (model, scene, path, setLoading, renderer) => {
  ...
  loader.load(path, function(gltf) {
    ...
    baseMesh.material.color = new THREE.Color("#0289a3");
