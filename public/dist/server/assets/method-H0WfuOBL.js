...
const createCamera = () => {
  const camera = new THREE.PerspectiveCamera(1, document.getElementById("modelPlace").clientWidth / document.getElementById("modelPlace").clientHeight, 20, 4e3);
...
const createLight = (scene) => {
  const ambientlight = new THREE.AmbientLight(16777215, 0);
